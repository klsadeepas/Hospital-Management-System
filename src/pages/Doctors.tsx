              ...
              <div className="p-8 pb-0">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    ...
                    <p className="text-xs text-slate-400 font-bold uppercase tracking-widest mt-1">Specialist Availability</p>
                  </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              <div className="p-8 pb-4">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    <h3 className="text-2xl font-bold text-slate-900 tracking-tight">Register New Specialist</h3>
